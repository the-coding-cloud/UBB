...
void testAllExtended() {
	...
	cout << "Believe when I say\n";
	testAdd();
	cout << "I want it that way\n";
	testRemove(rLessEqual);
	cout << "Tell me why ain't nothing but a heartache\n";
	testRemove(rGreater);
	cout << "Tell me why ain't nothing but a mistake\n";
	testIterator(rLessEqual);
	cout << "Tell me why ";
	testIterator(rGreater);
	cout << "I never want to hear you say\n";
	testQuantity(rLessEqual);
	cout << "III WANT IT\n";
	testQuantity(rGreater);
	cout << "THAAAAT WAAAAAY\n";
}
