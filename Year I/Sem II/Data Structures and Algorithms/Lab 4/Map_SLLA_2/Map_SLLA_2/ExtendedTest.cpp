...
void testAllExtended() {
	testCreate();
	cout << "If you're happy and you know it clap your hands\n";
	testAdd();
	cout << "If you're happy and you KNOW IT CLAP YOUR HANDS\n";
	testRemove();
	cout << "IF YOU'RE HAPPY AND YOU KNOW IT\n";
	testIterator();
	cout << "AND YOU REALLY WANT TO SHOW IT\n";
	testQuantity();
	cout << "IF YOU'RE HAPPY AND YOU KNOW IT CLAP YOUR HANDS, THE TESTS PASSED\n";
}
