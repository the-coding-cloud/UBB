...
class Console(object):
    ...
    def UIDijkstra(self):
        '''
        Function that computes the walk of minimal cost between two given vertices
        '''
        try:
            startVertex = int(input("Start vertex: ").strip())
            endVertex = int(input("End vertex: ").strip())
            self.__controller.Dijkstra(startVertex, endVertex)
        except ValueError as ve:
            print(ve)
    ...
    def printMenu(self):
        ...
        print("17. Find the path of minimal cost between two vertices")
        print("18. Exit")
