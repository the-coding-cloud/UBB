...
public class ProgramSelectionController implements Initializable {
    ...
    private void generateStatements() {
        ...
        IStatement line1 = new CompStatement(new VarDeclStatement("v1", new RefType(new IntType())),
                new CompStatement(new VarDeclStatement("v2", new RefType(new IntType())),
                        new CompStatement(new VarDeclStatement("x", new IntType()), new VarDeclStatement("q", new IntType()))));

        IStatement line2 = new CompStatement(new NewStatement("v1", new ValueExp(new IntValue(20))),
                new CompStatement(new NewStatement("v2", new ValueExp(new IntValue(30))),
                        new NewLockStatement("x")));

        IStatement fork1Stmt1 = new ForkStatement(new CompStatement(new LockStatement("x"), new CompStatement(new WriteHeapStatement("v1", new ArithmExp(2, new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(1)))), new UnlockStatement("x"))));
        IStatement fork1Stmt2 = new CompStatement(new LockStatement("x"), new CompStatement(new WriteHeapStatement("v1", new ArithmExp(3, new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(10)))), new UnlockStatement("x")));
        IStatement fork1 = new ForkStatement(new CompStatement(fork1Stmt1, fork1Stmt2));

        IStatement line4 = new NewLockStatement("q");

        IStatement fork2Stmt1 = new ForkStatement(new CompStatement(new LockStatement("q"), new CompStatement(new WriteHeapStatement("v2", new ArithmExp(1, new ReadHeap(new VarExp("v2")), new ValueExp(new IntValue(5)))), new UnlockStatement("q"))));
        IStatement fork2Stmt2 = new CompStatement(new LockStatement("q"), new CompStatement(new WriteHeapStatement("v2", new ArithmExp(3, new ReadHeap(new VarExp("v2")), new ValueExp(new IntValue(10)))), new UnlockStatement("q")));
        IStatement fork2 = new ForkStatement(new CompStatement(fork2Stmt1, fork2Stmt2));

        IStatement line6Nope = new CompStatement(new NopeStatement(), new CompStatement(new NopeStatement(), new CompStatement(new NopeStatement(), new NopeStatement())));

        IStatement line7 = new CompStatement(new LockStatement("x"), new CompStatement(new PrintStatement(new ReadHeap(new VarExp("v1"))), new UnlockStatement("x")));
        IStatement line8 = new CompStatement(new LockStatement("q"), new CompStatement(new PrintStatement(new ReadHeap(new VarExp("v2"))), new UnlockStatement("q")));

        IStatement ex11 = new CompStatement(new VarDeclStatement("v1", new RefType(new IntType())),
                new CompStatement(new VarDeclStatement("v2", new RefType(new IntType())),
                        new CompStatement(new VarDeclStatement("x", new IntType()),
                                new CompStatement(new VarDeclStatement("q", new IntType()),
                                        new CompStatement(new NewStatement("v1", new ValueExp(new IntValue(20))),
                                                new CompStatement(new NewStatement("v2", new ValueExp(new IntValue(30))),
                                                        new CompStatement(new NewLockStatement("x"),
                                                                new CompStatement(new ForkStatement(new CompStatement(fork1Stmt1, new CompStatement(new LockStatement("x"), new CompStatement(new WriteHeapStatement("v1", new ArithmExp(3, new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(10)))), new UnlockStatement("x"))))),
                                                                        new CompStatement(new NewLockStatement("q"),
                                                                                new CompStatement(new ForkStatement(new CompStatement(fork2Stmt1, new CompStatement(new LockStatement("q"), new CompStatement(new WriteHeapStatement("v2", new ArithmExp(3, new ReadHeap(new VarExp("v2")), new ValueExp(new IntValue(10)))), new UnlockStatement("q"))))),
                                                                                        new CompStatement(new NopeStatement(),
                                                                                                new CompStatement(new NopeStatement(),
                                                                                                        new CompStatement(new NopeStatement(),
                                                                                                                new CompStatement(new NopeStatement(),
                                                                                                                        new CompStatement(new LockStatement("x"),
                                                                                                                                new CompStatement(new PrintStatement(new ReadHeap(new VarExp("v1"))),
                                                                                                                                        new CompStatement(new UnlockStatement("x"),
                                                                                                                                                new CompStatement(new LockStatement("q"),
                                                                                                                                                        new CompStatement( new PrintStatement(new ReadHeap(new VarExp("v2"))),
                                                                                                                                                                new UnlockStatement("q"))))))))))))))))))));

        //System.out.println(ex11.toString());
        ex11.typeCheck(new GenericDictionary<String, Type>());
    ...
    private Controller generateController(int statementIndex){
        ...
        ProgramState program = new ProgramState(exeStack, symTable, output, fileTable, heap, lockTable, programStatements.get(statementIndex));
