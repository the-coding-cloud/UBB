...
public class ProgramState {
    ...
    public ProgramState(IStack<IStatement> stack, IDictionary<String, Value> symTable, IList<Value> out, IDictionary<StringValue, BufferedReader> fileT, IHeap h, IStatement program){
        exeStack = stack;
