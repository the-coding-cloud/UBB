...
class Question:
    ...
    """
    # TODO: Change representation --- LIST OF VALUES
...
# infoGain(true_rows, false_rows, current_uncertainty)
#
...
def findBestSplit(rows):
    ...
    for col in range(n_features):  # for each feature
        ...
        # TODO: for non-numerical - split by all values; for numerical, do smth proportional
...
# best_gain, best_question = findBestSplit(training_data)
...
if __name__ == '__main__':
    ...
    training_data = total_data[:500]
    testing_data = total_data[500:]
